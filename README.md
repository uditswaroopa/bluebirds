...
-Class Model was created
-tap function was added
- allclear function added
- Use of StatefulWidget in place of StatelessWidget
-final Model object was then initialized and passed to _LCDState Class
- height and margin value edited
-flex value was also modified
-function was replaced by allclear
